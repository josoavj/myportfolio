...
1. Télécharger `myportfolio-v1.4.0.apk`
2. Sur Android : Paramètres > Sécurité > Activer "Sources inconnues"
3. Ouvrir le fichier APK et installer

### 🐛 Bugfixes & Optimisations

- Correction du padding des sections mobile
- Optimisation des tailles de cartes
- Amélioration de la pagination des projets
- Meilleure gestion du safe area sur mobile
...
Josoa Vonjiniaina - Full Stack Developer

---

**Version précédente :** v1.3.1  
